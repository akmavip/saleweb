...
<div class="panel panel-danger">
	...
	<table class="table table-hover">
		...
		<c:forEach var="a" items="${data}">
			...
			<tr>
				...
				<td><f:formatNumber value="${a[2]}" pattern="#,### VND"/></td>
				<td><f:formatNumber value="${a[3]}" pattern="#,### VND"/></td>
				<td><f:formatNumber value="${a[4]}" pattern="#,### VND"/></td>
				<td><f:formatNumber value="${a[5]}" pattern="#,### VND"/></td>
			</tr>
		</c:forEach>
		</tbody>
	</table>
	...
	<div class="panel-footer">
		<strong>TỔNG DOANH THU : $<f:formatNumber value="${total}" pattern="#,### VND"/></strong>
	</div>
</div>